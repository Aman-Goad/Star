...
class CreateUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create create_user" do
    assert_difference("CreateUser.count") do
      post create_users_url, params: { create_user: { email: @create_user.email, string: @create_user.string, username: @create_user.username } }
    end
  ...
  test "should update create_user" do
    patch create_user_url(@create_user), params: { create_user: { email: @create_user.email, string: @create_user.string, username: @create_user.username } }
